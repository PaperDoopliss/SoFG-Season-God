...
{
    public class Ch_Season_SeekArtifactEvil : Challenge
    {
        public Pr_Season_HiddenArtifact property;

        public Ch_Season_SeekArtifactEvil(Location loc, Pr_Season_HiddenArtifact property) : base(loc) { this.property = property; }
