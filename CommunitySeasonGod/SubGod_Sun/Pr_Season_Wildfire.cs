...
namespace CommunitySeasonGod
{
    ...
    public class Pr_Season_Wildfire : Property
    {
        ...
        public static double presenceCutoff = 80;
        ...
        public override void turnTick()
        {
            ...
            if (fuelSource != null)
            {
                ...
                double presenceToBurn = Math.Max(presenceBurnedPerTurn,fuelSource.charge);
